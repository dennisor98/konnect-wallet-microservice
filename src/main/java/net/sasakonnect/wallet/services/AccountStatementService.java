...
public class AccountStatementService {
    ...
    public void readFileAndGeneratePDF(String jobId,String filePath) {
        String[] expectedHeaders = {"Transaction Date", "Transaction ID", "Transaction Type", "Transaction Details", "Currency","Debit Amount", "Credit Amount", "Account Balance"};
        ...
        try {
            ...
            try (InputStream inputStream = Files.newInputStream(csvFile.toPath());
            	...
            	try (PdfDocument pdfDocument = new PdfDocument(new PdfWriter("/home/ahdev/application/statements/"+jobId+".pdf"))) {
                    ...
                    while ((nextRecord = csvReader.readNext()) != null) {
                        for (String cell : nextRecord) {
                            ...
                            if (isFirstRow) {
                                paragraph.setBold()
                                .setFontSize(12)
                                .setBackgroundColor(new DeviceRgb(211, 211, 211)); // Light gray color
