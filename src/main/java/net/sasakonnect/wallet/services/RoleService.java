...
public class RoleService {
	...
	public Role insertRole(Role role) {
		...
		if (existingRole.isEmpty()) {
			...
			return savedRole;
//			var resultRole= Role.builder().roleName(savedRole.getRoleName())
//					.description(savedRole.getDescription())
//					.build();
//			resultRole.setId(savedRole.getId());
//			return resultRole;
		} else {
	...
	@Transactional
	public Object insertPermissionsNotAttachedToRole(Role role, User creator, List<String> permissionIds) {
        ...
        return resMap.put("payload", resMap);
	...
	public Object getRolePermissions(User user) {
		Map<String,Object> map =  new HashMap<>();
		Map<String,Object> resMap  =  new HashMap<>();
