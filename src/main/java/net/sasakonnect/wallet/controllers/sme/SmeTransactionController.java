...
public class SmeTransactionController {
	...
	@SmeCorporate
	@GetMapping("")
	@HasSmePermission(GlobalSmePermissionConstants.CanViewTransactions.PERMISSION)
	public ResponseEntity<Object> getTransactions(@RequestParam(name="pageNumber",defaultValue="0") Integer pageNumber,@RequestParam(name="pageSize",defaultValue="10") Integer pageSize){
		return this.smeTransactionService.getSmeTransactions(pageNumber, pageSize);
	}
//	CanViewTransactions
