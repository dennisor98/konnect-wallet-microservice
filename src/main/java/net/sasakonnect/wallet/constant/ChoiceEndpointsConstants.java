...
//	public static final String BASE_URL = "https://baas-pilot.choicedigitalbank.com";
	...
	public static final String PULL_KYC_MATERIALS = "/onboarding/getKycMedia";
	...
	public static final String INTERNAL_TRANSFER = "/trans/baasIntlTx";
	public static final String WITHDRAW = "/trans/v2/applyForTransfer";
	public static final String WALLET_BATCH_TRANS = "/trans/batchTransitionalFundsDisbursement";
	...
	public static final String ADD_SME_ACCOUNT_ADMINISTRATOR = "/account/v2/addAccountAdministrator";
	public static final String VERIFY_SME_ACCOUNT_ADMINISTRATOR_MOBILE = "/account/v2/addAccountAdministrator";


//	/account/verifyAccountAdministrator
}
